...
fun DivisionScreen(navController: NavController, mathModel: MathModel = viewModel()) {
    ...
    var score by remember { mutableStateOf(sharedPrefs.getInt("division_score", 0)) }
    ...
    fun fetchNewQuestion() {
        mathModel.sendPrompt(
            null,
            "Generate a simple division question for kids and provide the correct answer. Response follows the pattern 'Question: ... Answer: ...'. Ensure the answer is not included in the question."
        )
    }
                                ...
                                Button(
                                    onClick = {
                                        if (userAnswer == correctAnswer) {
                                            ...
                                            sharedPrefs.edit().putInt("division_score", score).apply()
                                            dialogTitle = "Correct!"
