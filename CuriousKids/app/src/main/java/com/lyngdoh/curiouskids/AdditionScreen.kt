...
fun AdditionScreen(navController: NavController, mathModel: MathModel = viewModel()) {
    ...
    var score by remember { mutableStateOf(sharedPrefs.getInt("addition_score", 0)) }
    ...
    fun fetchNewQuestion() {
        mathModel.sendPrompt(
            null,
            "Generate a simple addition question for kids and provide the correct answer. Response follows the pattern 'Question: ... Answer: ...'. Ensure the answer is not included in the question."
        )
    }
                                ...
                                Button(
                                    onClick = {
                                        if (userAnswer == correctAnswer) {
                                            ...
                                            sharedPrefs.edit().putInt("addition_score", score).apply()
                                            dialogTitle = "Correct!"
