...
fun SubtractionScreen(navController: NavController, mathModel: MathModel = viewModel()) {
    ...
    var score by remember { mutableStateOf(sharedPrefs.getInt("subtraction_score", 0)) }
    ...
    fun fetchNewQuestion() {
        mathModel.sendPrompt(
            null,
            "Generate a simple subtraction question for kids and provide the correct answer. Response follows the pattern 'Question: ... Answer: ...'. Ensure the answer is not included in the question."
        )
    }
                                ...
                                Button(
                                    onClick = {
                                        if (userAnswer == correctAnswer) {
                                            ...
                                            sharedPrefs.edit().putInt("subtraction_score", score).apply()
                                            dialogTitle = "Correct!"
